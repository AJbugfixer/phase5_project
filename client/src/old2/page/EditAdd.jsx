               ...
               <div className="row">
                   ...
                   <div className="card">
                                <form onSubmit={onSub}>
                                    ...
                                    <div className="form-group">
                                        <label >Email:</label>
                                        <input type="text" className="form-control" name='email' readOnly placeholder="Enter Email" value={email}  onChange={(e)=>setEmail(e.target.value)} required />
                                    </div>
                                    <div className="form-group">
                                        <label >Phone:</label>
                                    ...
                                    <div className="text-center mb-5">
                                        <input type="submit" className="btn btn-info pt-2 pb-2 pl-5 pr-5" value="Edit Address" />
                                    </div>
                                </form>
                            </div>
                   </div>
