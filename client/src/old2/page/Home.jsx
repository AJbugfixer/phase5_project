        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6 col-12 mb-3 mx-auto">
              <h1>
                Welcome to <span>Ecommerce</span>
              </h1>
              <p>
        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className=" col-md-6 col-12 mx-auto mb-3 d-flex justify-content-center align-items-center flex-column">
              ...
              <p>
                Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                Placeat cupiditate aspernatur, aperiam consequatur fugiat nisi!
                At labore corrupti, non vitae libero obcaecati, necessitatibus,
                odio facilis aliquid odit nulla porro itaque.
              </p>
              <button className="btn btn-outline-success">Read More</button>
            </div>
          </div>
